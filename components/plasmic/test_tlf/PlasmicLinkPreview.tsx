...
import sty from "./PlasmicLinkPreview.module.css"; // plasmic-import: -o6UC37YUJTZ/css
...
function PlasmicLinkPreview__RenderFunc(props: {
  ...
  return (
    ...
    >
      <DataCtxReader__>
        {$ctx => (
          <div className={classNames(projectcss.all, sty.freeBox___7SV46)}>
            <PlasmicImg__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__sWsZ1)}>
              <div className={classNames(projectcss.all, sty.freeBox__wuSl7)}>
                <h5
